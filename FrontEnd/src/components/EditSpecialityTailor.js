...
export const EditSpecialityTailor = ({
  talorID,
  editSpeciality,
  allSpecialities,
  updateSpecialties,
  ...
  const clickHandler = () => {
    ...
    if (
      service.length > 0 &&
      price >= 0 &&
      (service != editSpeciality["name"] ||
        price != parseInt(editSpeciality["price"]))
    ) {
  ...
  return (
    <div
      class="modal fade"
      id="editSpecialityTailor"
      tabindex="-1"
      aria-labelledby="EditSpecialityTailorLabel"
      aria-hidden="true"
    >
